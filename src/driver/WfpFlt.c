...
#define WFP_INBOUND_IPPACKET_V4_CALLOUT_DEFINITION \
    __WFP_DECLARE_CALLOUT_DEFINITION( \
    &FWPM_LAYER_INBOUND_IPPACKET_V4, \
    FWPS_LAYER_INBOUND_IPPACKET_V4, \
    Wfp_Inbound_IpPacket_Callback)

#define WFP_INBOUND_IPPACKET_V6_CALLOUT_DEFINITION \
    __WFP_DECLARE_CALLOUT_DEFINITION( \
    &FWPM_LAYER_INBOUND_IPPACKET_V6, \
    FWPS_LAYER_INBOUND_IPPACKET_V6, \
    Wfp_Inbound_IpPacket_Callback)

#define WFP_OUTBOUND_IPPACKET_V4_CALLOUT_DEFINITION \
    __WFP_DECLARE_CALLOUT_DEFINITION( \
    &FWPM_LAYER_OUTBOUND_IPPACKET_V4, \
    FWPS_LAYER_OUTBOUND_IPPACKET_V4, \
    Wfp_Outbound_IpPacket_Callback)

#define WFP_OUTBOUND_IPPACKET_V6_CALLOUT_DEFINITION \
    __WFP_DECLARE_CALLOUT_DEFINITION( \
    &FWPM_LAYER_OUTBOUND_IPPACKET_V6, \
    FWPS_LAYER_OUTBOUND_IPPACKET_V6, \
    WfpOutbound_IpPacket_Callback)
