...
#define MilisecondsToXNanoseconds(Value, Divider)   (Divider <= NanosecondsInMilisecond ?  ((LONGLONG)(Value) * (NanosecondsInMilisecond / (LONGLONG)(Divider))) : ((LONGLONG)Value * NanosecondsInMilisecond / (LONGLONG)(Divider)))
